        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="p-8">
            <div className="space-y-6">
              ...
              {/* Login Button */}
              <button 
                className="w-full bg-gradient-to-r from-[#7a0000] to-[#a31111] hover:from-[#5a0000] hover:to-[#7a0000] text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-[#7a0000]/50 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none" 
                onClick={submit}
                disabled={loading}
              >
