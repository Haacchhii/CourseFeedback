...
export default function SentimentAnalysis() {
  ...
  // Get semester options from actual evaluation data
  const semesterOptions = useMemo(() => {
    const semesters = [...new Set(accessibleEvaluations.map(e => e.semester).filter(Boolean))].sort()
    return semesters
  }, [accessibleEvaluations])

  // Filter evaluations by semester
  const filteredEvaluationsBySemester = useMemo(() => {
    if (selectedSemester === 'all') return accessibleEvaluations
