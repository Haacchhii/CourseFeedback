...
import { getCurrentUser, filterCoursesByAccess, filterEvaluationsByAccess, isAdmin, isDepartmentHead, isSystemAdmin } from '../../utils/roleUtils'
...
export default function Dashboard() {
  ...
  // Redirect students to evaluation page, system admins to admin dashboard
  useEffect(() => {
    if (!currentUser) {
      navigate('/')
      return
    ...
    // Redirect System Administrators to their dedicated dashboard
