...
- generic [ref=e3]:
  ...
  - main [ref=e40]:
    - generic [ref=e42]:
        ...
        - generic [ref=e55]:
          - generic [ref=e56]:
            ...
            - generic [ref=e60]:
              ...
              - button "Create Section" [active] [ref=e64] [cursor=pointer]:
                - img [ref=e65]
                - text: Create Section
      ...
      - generic [ref=e273]:
        - generic [ref=e275]:
          - heading "➕ Create New Section" [level=2] [ref=e276]
          - button [ref=e277] [cursor=pointer]:
            - img [ref=e278]
        - generic [ref=e280]:
          - generic [ref=e281]:
            - generic [ref=e282]: Program *
            - combobox [ref=e283]:
          ...
          - generic [ref=e284]:
            ...
            - combobox [disabled] [ref=e286]:
              ...
              - option "3rd Year"
              - option "4th Year"
            - paragraph [ref=e287]: Select a program first
          - generic [ref=e288]:
            - generic [ref=e289]: Semester *
            - combobox [disabled] [ref=e290]:
              - option "Select semester" [selected]
              - option "First Semester"
              - option "Second Semester"
              - option "Summer"
            - paragraph [ref=e291]: Select year level first
          - generic [ref=e292]:
            - generic [ref=e293]: Course *
            - combobox [disabled] [ref=e294]:
              - option "Select a course" [selected]
            - paragraph [ref=e295]: Select semester first
          - generic [ref=e296]:
            - generic [ref=e297]: Section Code *
            - textbox "e.g., CS101-A, IT201-1" [ref=e298]
          - generic [ref=e299]:
            - generic [ref=e300]:
              - generic [ref=e301]: Academic Year *
              - textbox "2024-2025" [ref=e302]
            - generic [ref=e303]:
              - generic [ref=e304]: Max Students *
              - spinbutton [ref=e305]: "40"
          - generic [ref=e306]:
            - button "Cancel" [ref=e307] [cursor=pointer]
            - button "Create Section" [ref=e308] [cursor=pointer]:
              - img [ref=e309]
              - generic [ref=e311]: Create Section
  - contentinfo [ref=e312]:
    - generic [ref=e314]: © 2025 Lyceum of the Philippines University - Batangas. All rights reserved.
```