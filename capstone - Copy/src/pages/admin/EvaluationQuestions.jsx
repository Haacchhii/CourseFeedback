...
// Evaluation questions will be fetched from database
  ...
  useEffect(() => {
    const loadQuestionSets = async () => {
      try {
        ...
        // For now, use empty array since we're removing mock data
        setQuestionSets([])
        setLoading(false)
      } catch (err) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading evaluation questions...</p>
        </div>
      </div>
    )
  }
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              >
                ...
                {isAdmin(currentUser) && <option value="global">Global</option>}
