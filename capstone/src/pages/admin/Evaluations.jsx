        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
          <div className="lpu-stat-card bg-gradient-to-br from-purple-500 to-purple-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Survey Participation</h3>
                <p className="text-2xl font-bold text-white">{evaluationStats.total}/{evaluationStats.totalEnrolledStudents}</p>
                <p className="text-xs text-purple-100">students ({evaluationStats.participationRate}%)</p>
              </div>
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-indigo-500 to-indigo-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Participation Rate</h3>
                <p className="text-2xl font-bold text-white">{evaluationStats.participationRate}%</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-green-500 to-green-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Positive Feedback</h3>
                <p className="text-2xl font-bold text-white">{evaluationStats.positive}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-yellow-500 to-yellow-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Neutral Feedback</h3>
                <p className="text-2xl font-bold text-white">{evaluationStats.neutral}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-red-500 to-red-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Negative Feedback</h3>
                <p className="text-2xl font-bold text-white">{evaluationStats.negative}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-[#7a0000] to-[#9a1000]">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Average Rating</h3>
                <p className="text-2xl font-bold text-white">{evaluationStats.overallAvgRating}/5.0</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
          ...
          {sentimentTrendData.length > 0 ? (
            <ResponsiveContainer width="100%" height={350}>
              <BarChart data={sentimentTrendData}>
                ...
                />
                <Bar dataKey="positive" fill="#059669" name="Positive" />
                <Bar dataKey="neutral" fill="#0891b2" name="Neutral" />
            ...
            <div>
              ...
              {isDepartmentHead(currentUser) ? (
                <input 
                  ...
                  readOnly
                  className="lpu-input bg-gray-50 text-gray-600 cursor-not-allowed"
