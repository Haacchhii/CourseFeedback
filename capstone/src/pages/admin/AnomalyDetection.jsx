        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="lpu-stat-card bg-gradient-to-br from-[#7a0000] to-[#9a1000]">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Total Anomalies</h3>
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-red-500 to-red-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">High Severity</h3>
                <p className="text-2xl font-bold text-white">{anomalyStats.high}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-yellow-500 to-yellow-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Medium Severity</h3>
                <p className="text-2xl font-bold text-white">{anomalyStats.medium}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-green-500 to-green-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Low Severity</h3>
                <p className="text-2xl font-bold text-white">{anomalyStats.low}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div key={anomaly.id} className="p-6 hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-25 transition-all duration-200 group">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-4 rounded-lg text-center border border-gray-300">
                    ...
                    <p className="text-2xl font-bold text-[#7a0000]">{anomaly.avgRating}/5.0</p>
                  </div>
