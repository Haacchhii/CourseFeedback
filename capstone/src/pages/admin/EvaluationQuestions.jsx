        ...
        <div className="grid md:grid-cols-5 gap-6 mb-8">
          <div className="lpu-stat-card bg-gradient-to-br from-[#7a0000] to-[#9a1000]">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Total Question Sets</h3>
                <p className="text-2xl font-bold text-white">{questionSetStats.total}</p>
              </div>
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-green-500 to-green-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Active Templates</h3>
                <p className="text-2xl font-bold text-white">{questionSetStats.active}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-gray-500 to-gray-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Archived Sets</h3>
                <p className="text-2xl font-bold text-white">{questionSetStats.archived}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-blue-500 to-blue-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Global Templates</h3>
                <p className="text-2xl font-bold text-white">{questionSetStats.global}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lpu-stat-card bg-gradient-to-br from-purple-500 to-purple-600">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">Department Sets</h3>
                <p className="text-2xl font-bold text-white">{questionSetStats.department}</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
